...
{
	public partial class Formnivel4 : Form
	{
		public int time = 0;
        ...
        private string imagePath = @"C:\Users\'\Documents\ProyectoProgramación\ProyectoProgramación\bin\Debug\img\fotos de niveles\persistencia.jpg";
		private int punt = 0;
		private PictureBox[] pictureBoxes;
		
		public Formnivel4(int userId)
		{
			InitializeComponent(); 
			imagenTimer = new Timer();
            imagenTimer.Interval = 1000; 
		...
		void Formnivel4Load(object sender, EventArgs e)
		{
		...
		void PictureBox5Click(object sender, EventArgs e)
        {
			...
			if (pic.Tag.ToString() == "0"){
				...
				if (punt==2000){
					...
					string qry = "exec sp_ActualizarNivelUsuario '" + userId + "', 5";
					miConexion.EjecutarSentencia(qry);
					Formnivel5 nivel5 = new Formnivel5(userId);
            		nivel5.Show();
            		this.Hide();
				}
				pic.Tag = "1";
