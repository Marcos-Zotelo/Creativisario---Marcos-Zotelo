...
namespace ProyectoProgramación
{
	...
	public partial class Formnivel2 : Form
	{
        ...
        private string imagePath = @"C:\Users\'\Documents\ProyectoProgramación\ProyectoProgramación\bin\Debug\img\fotos de niveles\observacion.png";
		private int punt = 0;
		private PictureBox[] pictureBoxes; 
		
		public Formnivel2(int userId)
		{
			InitializeComponent();
			imagenTimer = new Timer();
            imagenTimer.Interval = 2000; 
		...
		void Formnivel2Load(object sender, EventArgs e)
		{
		...
		void Timer1Tick(object sender, EventArgs e)
       {
		...
		public void PictureBox5Click(object sender, EventArgs e)
        {
			...
			if (pic.Tag.ToString() == "0"){
				...
				if (punt==2000){
					...
					string qry = "exec sp_ActualizarNivelUsuario '" + userId + "', 3";
					miConexion.EjecutarSentencia(qry);
					Formnivel3 nivel3 = new Formnivel3(userId);
            		nivel3.Show();
            		this.Hide();
				}
				pic.Tag = "1";
